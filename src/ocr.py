...
from translate import translate_text_to
...
def main():
    ...
    ap.add_argument("-p", "--psm", type=int, default=4,
        help="Tesseract PSM mode")
    ap.add_argument("-o", "--oem", type=int, default=3,
    ...
    options = "-l {} --psm {}, --oem {}".format(args["lang"], args["psm"], args["oem"])
