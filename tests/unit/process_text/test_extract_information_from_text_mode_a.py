...
import pytest
from src.process_text import extract_information_from_text_mode_a
...
@pytest.mark.parametrize(
    "ocr_text, attribute_names, expected_result", [
        (
            ...
            pytest.lazy_fixture("create_expected_result_extract_information_from_text_mode_a")
        ),
        (
...
def test_extract_information_from_text_mode_a(ocr_text, attribute_names, expected_result):
    result = extract_information_from_text_mode_a(ocr_text, attribute_names, "dummyname")
