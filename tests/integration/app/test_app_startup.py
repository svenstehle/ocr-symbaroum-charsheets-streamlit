...
class StartupTest(BaseCase):
    def test_app_startup(self):
        ...
        self.assert_text(
            "Upload an Image",
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[3]/div/label',
        )
        self.assert_text(
            "Drag and drop file here",
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[3]/div/section/div/div/span',
        )
        self.assert_text(
            "PNG, TIFF",
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[3]/div/section/div/div/small',
        )
        # image rescaling
        self.assert_text(
        ...
        self.assert_text(
            ...
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[7]/div/div/h2',
        )
        self.assert_text(
            "Choose one that works best for your image.",
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[8]/div/label',
        )
        self.assert_text(
            "Assume a single uniform block of text",
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[8]/div/div/label[1]/div[2]',
        )
        self.assert_text(
            "Assume a single column of text of variable sizes",
            '//*[@id="root"]/div[1]/div[1]/div/div/div/section[1]'
            '/div[1]/div[2]/div/div[1]/div/div[8]/div/div/label[2]/div[2]',
        )
