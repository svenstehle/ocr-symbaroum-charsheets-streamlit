...
change the values here and add "--settings=visual_testing.py" when running.
"""

# taken from https://github.com/seleniumbase/SeleniumBase/blob/master/examples/custom_settings.py
...
ENCRYPTION_KEY = "Pg^.lr6dfx7dMIe&fl*%!p5##f]7]9*^&4%6?"
